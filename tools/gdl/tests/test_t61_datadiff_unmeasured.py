...
Reproduced at cd814fc78 with build/t4_scratch/t4_datadiff_zeros.py:

    exception_table over an unreadable object ->
...
established. The live population at that commit has no error-branch row --
every UNRESOLVED there (mb_objects extra=1, DEMOInit extra=6) carries REAL
measured counts and must keep them, which is the negative side below.
"""
import json
import os
import sys
