...
TWO-SIDED over the 269 (unit, section) pairs that resolve any base
(build/t4_scratch/t4_af_rule_delta.py): 5 paste lines gained, 5 withdrawn
because the single candidate is measurably wrong, 259 unchanged.
"""
import os
import sys
import unittest
