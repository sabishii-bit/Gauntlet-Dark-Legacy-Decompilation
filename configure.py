...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "game/mb/mb_particle.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            ...
            Object(NonMatching, "game/audio/dcs.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            Object(NonMatching, "game/audio/buffile.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            Object(NonMatching, "game/audio/dcsdrv.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            Object(NonMatching, "game/audio/mempool.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            ...
            Object(NonMatching, "game/world/dynobjgrid.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            ...
            Object(NonMatching, "game/audio/audio.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
            ...
            Object(NonMatching, "game/mb/mb_objects.c", cflags=cflags_demo, mw_version="GC/1.2.5"),
