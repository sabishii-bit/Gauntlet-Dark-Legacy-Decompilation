...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(Matching, "game/world/glue.c", cflags=cflags_demo),
            Object(NonMatching, "game/world/hiscore.c", cflags=cflags_demo),
            Object(NonMatching, "game/world/camera.c", cflags=cflags_demo),
            Object(Matching, "game/game/clock.c", cflags=cflags_demo),
            ...
            Object(Matching, "game/world/dynobjgrid.c", cflags=cflags_demo),
            ...
            Object(Matching, "game/sys/dbmodes.c", cflags=cflags_demo),
