...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "game/sys/main.c", cflags=cflags_demo),
            ...
            Object(NonMatching, "game/mb/mb_lights.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_main.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_model.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_struct.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_tree.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_util.c", cflags=cflags_demo),
            Object(NonMatching, "game/mb/mb_window.c", cflags=cflags_demo),
            Object(NonMatching, "game/ps2/ml_error.c", cflags=cflags_demo),
            Object(NonMatching, "game/ps2/ml_ffsincos.c", cflags=cflags_demo),
            ...
            Object(NonMatching, "game/world/dyngrid.c", cflags=cflags_demo),
            ...
            Object(NonMatching, "game/audio/soundmgr.c", cflags=cflags_demo),
