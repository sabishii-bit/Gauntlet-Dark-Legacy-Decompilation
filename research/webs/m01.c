/* m01: faithful MBNewObject skeleton (our current repo shape) */
typedef unsigned int u32; typedef signed int s32; typedef unsigned char u8;
typedef struct MBObject {
    u8 pad0[82]; u8 type; u8 pad1[13]; u32 flags; u8 pad2[8];
    s32 index; void* romobj;
} MBObject;
    ...
    if (objid == -1) {
        ...
        if (obj != 0) {
            ...
            if (objid < 0) {
                ...
                obj->index = objid;
                obj->romobj = (u8*)*(void**)((u8*)table + 0x54) +
                              ((objid << 6) & 0x003FFFC0);
                obj->type = 2;
                obj->flags &= ~1u;
            }
