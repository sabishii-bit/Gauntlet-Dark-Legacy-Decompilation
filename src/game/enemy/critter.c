...
typedef struct CritterHitNode {
    ...
    void *boundNode;      /* 0x08 secondary node handle; walked via +0x74/+0x78
                            * MBNode parent/child links in CritterInitColnodes */
    f32 matrix[12];
    f32 position[3];
    u8 _pad48[4];
        ...
        if ((((CritterPackedType *)c->hdr)->typeFlags & 0x100) != 0) {
            ...
            if (result != 0) {
                sep[0] = *(f32 *)((u8 *)player + offsetof(Player, effectpos)) -
                         *(f32 *)((u8 *)c + result * sizeof(CritterHitNode) +
                                   (offsetof(Critter, hitnodes) + offsetof(CritterHitNode, position) - sizeof(CritterHitNode)));
                sep[1] = *(f32 *)((u8 *)player + offsetof(Player, effectpos) + 4) -
                         *(f32 *)((u8 *)c + result * sizeof(CritterHitNode) +
                                   (offsetof(Critter, hitnodes) + offsetof(CritterHitNode, position) - sizeof(CritterHitNode) + 4));
                sep[2] = *(f32 *)((u8 *)player + offsetof(Player, effectpos) + 8) -
                         *(f32 *)((u8 *)c + result * sizeof(CritterHitNode) +
                                   (offsetof(Critter, hitnodes) + offsetof(CritterHitNode, position) - sizeof(CritterHitNode) + 8));
            }
        } else {
...
f32 *delta;
{
    ...
    if ((((CritterPackedType *)c->hdr)->typeFlags & 0x100) != 0) {
        ...
        for (i = 0; i < ((CritterPackedType *)c->hdr)->colCount;
            ...
            if ((*(s16 *)((u8 *)hitNode->descriptor + offsetof(CritterColDescriptor, flags)) & 8) == 0) {
                continue;
            }
            from = (f32 *)((u8 *)hitNode + offsetof(CritterHitNode, position));
...
s32 CritterNodeEnemyCollide(Critter *c, void *damageDef)
{
    ...
    radius = *(f32 *)(dmg + offsetof(CritterDamageDef, damage)) * *(f32 *)((u8 *)gCurLevel + offsetof(level_data, ene_damage));
    f26v = *(f32 *)(dmg + offsetof(CritterDamageDef, maxDistance));
    count = 0;
    MulVecMat3((f32 *)(dmg + offsetof(CritterDamageDef, offset)), out, c->worldMoveMatrix);
...
void CritterLookAtPlayer(Critter *c, CritterMove *move)
{
    ...
    if (c->hitnode0 != NULL) {
        NodeLookAtPos(c->hitnode0, targetPtr,
                      *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookYawRate0)), lbl_80346470,
                      (f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x20),
                      *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookPitchRate0)), *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookPitchBias0)),
                      (f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x28));
    }
    if (c->hitnode1 != NULL) {
        NodeLookAtPos(c->hitnode1, targetPtr,
                      *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookYawRate1)), lbl_80346470,
                      (f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x24),
                      *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookPitchRate1)), *(f32 *)((u8 *)hdr + offsetof(CritterPackedType, lookPitchBias1)),
                      (f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x2C));
    }
}
                                              ...
                                              f32 zero, f64 hitTimeBase)
{
    ...
    damageFlags = *(u32 *)(damageDef + offsetof(CritterDamageDef, flags)) | flags;
    playerIndex = player->index;
    damage = *(f32 *)(damageDef + offsetof(CritterDamageDef, damage)) *
             *(f32 *)((u8 *)gCurLevel + offsetof(level_data, ene_damage));
    if (playSfx != 0 && *(s16 *)(damageDef + offsetof(CritterDamageDef, sfx)) >= 0) {
        CritterDoSfx(c, *(s16 *)(damageDef + offsetof(CritterDamageDef, sfx)), &player->pos[0], 0, -1);
        damageFlags |= 0x01000000;
    }
    descriptor = *(u8 **)((u8 *)c->hdr + offsetof(CritterPackedType, descriptor));
    if (*(s16 *)(descriptor + offsetof(CritterDescriptor, type)) != 4 &&
    ...
    *(f32 *)(counter + offsetof(Critter, unk1BC)) += damage;
    *(f32 *)(counter + (offsetof(Critter, unk1BC) + 4)) = sMusicFadeBase;
}
...
/* 0x80036A58 */ s32 CritterGetTargetSub(Critter *c, f32 *target, s32 mode)
{
    ...
    if (best >= 0) {
        ...
        best = *(s32 *)(address + offsetof(Critter, targetPlayer));
...
f32 CritterReCalcTarget(Critter *c, f32 *moveTarget, s32 target)
{
    ...
    entry = (f32 *)((u8 *)c + offsetof(Critter, targetPlayer) + target * 0x24);
    if (moveTarget != NULL) {
        if (*(f32 *)((u8 *)c + offsetof(Critter, rateScale)) < moveTarget[4]) {
            return lbl_80346518;
        }
        if (moveTarget[5] > moveTarget[4] &&
            *(f32 *)((u8 *)c + offsetof(Critter, rateScale)) >= moveTarget[5]) {
            return lbl_80346518;
        }
    }
...
void CritterGetSingleTargetPlayer(Critter *c)
{
    ...
    if (c->targetCount != 0) {
        c->particle = NULL;
        gBig.scratch[*(s32 *)((u8 *)c + offsetof(Critter, targetPlayer))] += lbl_803464A8;
    }
}
...
void CritterResolveMultipleTargets(Critter *c)
{
    ...
    for (i = 0; i < c->targetCount; i++, outerOffset += 0x24) {
        CritterTargetRecord *record = (CritterTargetRecord *)
            ((u8 *)c + offsetof(Critter, targetPlayer) + outerOffset);
...
void CritterGetTargetPlayers(Critter *c)
{
    ...
    for (i = 0; i < c->targetCount; i++) {
        s32 index = *(s32 *)((u8 *)c + offsetof(Critter, targetPlayer) + i * 0x24);
        if (index >= 0) {
                          ...
                          s32 first)
{
    ...
    while (i < *(s16 *)((u8 *)c->hdr + offsetof(CritterPackedType, colCount))) {
        ...
        if (*(void **)(base + (offsetof(Critter, hitnodes) + offsetof(CritterHitNode, active))) == NULL ||
            *(f32 *)(node + offsetof(CritterHitNode, activeFrom)) >= *(f32 *)(node + offsetof(CritterHitNode, activeUntil)) ||
            (*(s16 *)(*(u8 **)node + offsetof(CritterColDescriptor, flags)) & 8) == 0) {
            goto next;
        }
        nodeDef = *(u8 **)node;
        nodeRadius = *(f32 *)(nodeDef + offsetof(CritterColDescriptor, radius));
                         ...
                         f32 *contact, s32 mode)
{
    ...
    while (offset < *(s16 *)((u8 *)c->hdr + offsetof(CritterPackedType, colCount))) {
        ...
        if (*(f32 *)(node + offsetof(CritterHitNode, activeFrom)) >= *(f32 *)(node + offsetof(CritterHitNode, activeUntil))) {
            goto next;
        }
        if (mode != 2 || (*(s16 *)(*(u8 **)node + offsetof(CritterColDescriptor, flags)) & 8) != 0) {
            dz = *(f32 *)(node + (offsetof(CritterHitNode, position) + 8)) - destination[2];
            nodeRadius = radius + *(f32 *)(*(u8 **)node + offsetof(CritterColDescriptor, radius));
            dx = *(f32 *)(node + offsetof(CritterHitNode, position)) - destination[0];
            if (dx * dx + dz * dz >
                nodeRadius * nodeRadius + squaredExpand) {
                goto next;
            }
            dy = *(f32 *)(node + (offsetof(CritterHitNode, position) + 4)) - destination[1];
            if (dy > nodeRadius + height) {
                goto next;
            }
            if (LineCylinderCollide((f32 *)(node + offsetof(CritterHitNode, position)), nodeRadius,
...
void CritterUpdateCounters(Critter *c)
{
    ...
    for (i = 0; i < 4; i++) {
        base = (u8 *)c + i * 0x10;
        counterTime = (f32 *)(base + (offsetof(Critter, unk1BC) + 4));
        current = *counterTime;
        if ((f64)current > zero &&
            (f64)(sMusicFadeBase - current) > timeout) {
            *(f32 *)(base + offsetof(Critter, unk1BC)) = clear;
            *counterTime = clear;
        }
        current = *(counterTime = (f32 *)(base + (offsetof(Critter, unk1BC) + 0xC)));
        if ((f64)current > zero &&
            (f64)(sMusicFadeBase - current) > timeout) {
            *(f32 *)(base + (offsetof(Critter, unk1BC) + 8)) = clear;
            *counterTime = clear;
        }
    }
}
...
s32 CritterGolemAI(Critter *c)
{
    ...
    if (c->state == 0) {
        if (c->particle == NULL) {
            best = lbl_80346470;
            for (i = 0; i < c->targetCount; i++) {
                f32 v = *(f32 *)((u8 *)c + offsetof(Critter, targetAngle) + i * 0x24);
                if (v > best) {
                    best = v;
                }
            }
...
s32 CritterBossAI(Critter *c)
{
    ...
    if (c->state == 0) {
        if ((f64)lbl_8034464C == 0.0) {
            ...
            distance = *(f32 *)((u8 *)c->hdr + 0xEC);
            best = 0.0f;
            for (i = 0; i < c->targetCount; i++) {
                f32 candidate = *(f32 *)((u8 *)c + offsetof(Critter, targetAngle) + i * 0x24);
                if (candidate > best) {
                    best = candidate;
                }
            }
                        ...
                        if (c->unk11C < *(s16 *)((u8 *)child->hdr + 0x114)) {
                            ...
                            child->nextmove = *(s16 *)(
                                *(u8 **)((u8 *)child->hdr + 0x128) +
                                child->unk11C * 0x50 + child->unk120 * 2 +
                                0x20);
                        }
    ...
    if ((gControllerButtons & 0x10) != 0 && gGameOptions[8] != 0) {
        ...
        angle = distance;
        if (c->targetCount > 0) {
            angle = *(f32 *)((u8 *)c + offsetof(Critter, targetAngle));
            if ((f64)angle >= 1e21) {
                angle = distance;
            }
            dot = *(f32 *)((u8 *)c + 0x130);
...
void CritterRotate(Critter *c, CritterMove *move)
{
    ...
    turn = *(f32 *)((u8 *)move + offsetof(CritterMove, turnRate));
    limit = *(f32 *)((u8 *)c->hdr + offsetof(CritterPackedType, turnLimit));
    if ((move->flags & 0x20) != 0) {
        delta = *(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x18) - *(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x1C);
    } else if (c->unk128 >= 0) {
        delta = lbl_80346470;
    } else {
        if (c->unk124 >= 0 && (f64)turn > 0.0) {
            ...
            if ((*(u32 *)((u8 *)c->hdr + offsetof(CritterPackedType, typeFlags)) & 0x400) != 0) {
                ...
                register f32 z = target[2];
                f32 angle = atan2(target[0], z) - *(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x18);
                f64 wideAngle;
                f32 clamped;
                ...
                delta = (*(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x18) + clamped) -
    ...
    if ((f64)delta != 0.0) {
        ...
        *(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x1C) =
            *(f32 *)((u8 *)c + offsetof(Critter, skinMatrix) + 0x1C) + delta;
...
/* -- CritterMoveNames: overlay of crit_move's three name strings (Xbox PDB
 *    crit_move 0x90 exact: name@0x10, anim@0x20, colnode@0x30, each char[16];
 *    the project header's CritterMove keeps the block as _blk10 padding). -- */
typedef struct CritterMoveNames {
    u8   _pad00[0x10];
    char name[0x10];     /* 0x10 crit_move.name -- editor/debug move name     */
    char anim[0x10];     /* 0x20 crit_move.anim -- animation sequence name    */
    char colnode[0x10];  /* 0x30 crit_move.colnode -- attach-node name        */
} CritterMoveNames;
...
void CritterAnimInterrupt(Critter *c, s32 action, s32 phase, s32 active)
{
    ...
    type = *(s16 *)(desc + offsetof(CritterDamageDef, type));
    switch (type) {
    case 5:
        if (active) {
            for (i = 0; i < lbl_80344658; i++) {
    ...
    case 0:
        ...
        if (c->emitter != NULL) {
            DmgFxCircleUpdate(c->emitter, *(f32 *)(desc + offsetof(CritterDamageDef, maxDistance)), 1);
        } else if ((gControllerButtons & 0x10) && gGameOptions[8]) {
            c->emitter = DmgFxCircleAdd(c->obj_d0, *(f32 *)(desc + offsetof(CritterDamageDef, maxDistance)),
                                        *(f32 *)(desc + offsetof(CritterDamageDef, pitch)),
                                        *(f32 *)(desc + offsetof(CritterDamageDef, yaw)),
    ...
    case 4:
        ...
        if (c->emitter != NULL) {
            DmgFxConeUpdate(c->emitter, *(f32 *)(desc + offsetof(CritterDamageDef, radius)),
                            *(f32 *)(desc + offsetof(CritterDamageDef, maxDistance)), *(f32 *)(desc + offsetof(CritterDamageDef, pitch)),
                            *(f32 *)(desc + offsetof(CritterDamageDef, yaw)), 1);
        } else if ((gControllerButtons & 0x10) && gGameOptions[8]) {
            c->emitter = DmgFxConeAdd(c->obj_d0, *(f32 *)(desc + offsetof(CritterDamageDef, radius)),
                                      *(f32 *)(desc + offsetof(CritterDamageDef, maxDistance)),
                                      *(f32 *)(desc + offsetof(CritterDamageDef, pitch)),
                                      *(f32 *)(desc + offsetof(CritterDamageDef, yaw)),
                                      (f32 *)(desc + offsetof(CritterDamageDef, offset)), 0);
        }
    ...
    case 7:
        if (phase == 1) {
            if (c->unk128 < 0) {
                ...
                if (node >= 0) {
                    pp = &gPlayers[node];
                    PlayerSetParent(pp, c->obj_d0, (f32 *)(desc + offsetof(CritterDamageDef, offset)));
                    c->unk128 = (s16)node;
    ...
    case 9:
        if (active) {
            f32 angle = acosf(*(f32 *)(desc + offsetof(CritterDamageDef, mindp)));
            v[0] = *(f32 *)((u8 *)c + 0x3F8);
            v[1] = *(f32 *)((u8 *)c + 0x3FC);
            v[2] = *(f32 *)((u8 *)c + 0x400);
            YawVec3(v, v, *(f32 *)(desc + offsetof(CritterDamageDef, yaw)));
            PitchVec3(v, v, *(f32 *)(desc + offsetof(CritterDamageDef, pitch)));
            v[0] = v[0] * *(f32 *)(desc + offsetof(CritterDamageDef, minSpeed));
            v[1] = v[1] * *(f32 *)(desc + offsetof(CritterDamageDef, minSpeed));
            v[2] = v[2] * *(f32 *)(desc + offsetof(CritterDamageDef, minSpeed));
...
s32 CritterDoSfx(Critter *c, s32 sfx, void *parent, s32 arg3, s32 arg4)
{
    ...
    flags = *(u32 *)(entry + offsetof(CritterSfxRecord, flags));
    ...
    color[0] = *(f32 *)(entry + offsetof(CritterSfxRecord, color)) * scale;
    ...
    if ((flags & 0x0F000000) != 0) {
        ...
        skinValue = *(f32 *)(entry + offsetof(CritterSfxRecord, rate));
        nodeCount = (s32)(lbl_80346630 * *(f32 *)(entry + offsetof(CritterSfxRecord, life)));
        skinParam = *(s16 *)(entry + offsetof(CritterSfxRecord, custom0));
        if (*(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) >= 0) {
            SetSkinFX((u8 *)c + offsetof(Critter, skinMatrix), *(s32 *)(entry + offsetof(CritterSfxRecord, textureId)),
                      nodeCount, skinParam, skinValue);
        } else {
            SetSkinFX((u8 *)c + offsetof(Critter, skinMatrix), lbl_802897B8[c->counterState & 0xF], 10,
                      0, lbl_803464E8);
        }
        ...
        for (; nodeCount < *(s16 *)((u8 *)c->hdr + offsetof(CritterPackedType, colCount));
            ...
            if ((*(s16 *)(*(u8 **)(node + offsetof(CritterHitNode, descriptor)) + offsetof(CritterColDescriptor, flags)) & 1) == 0) {
                world[0] = *(f32 *)(node + offsetof(CritterHitNode, position)) + color[0];
    ...
    } else if (*(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) >= 0) {
        if ((flags & 0x801) != 0) {
            arg3 = 1;
            world[0] = color[0];
            world[1] = color[1];
    ...
    audio = *(s32 *)(entry + offsetof(CritterSfxRecord, audioId));
    if (audio >= 0) {
        if (c->curmove >= 0 &&
    ...
    if ((*(u32 *)(entry + offsetof(CritterSfxRecord, flags)) & 0x40000) != 0) {
        if (c->unkABA >= 0) {
    ...
    if (*(s32 *)(entry + offsetof(CritterSfxRecord, linkIndex)) >= 0) {
        CritterDoSfx(c, *(s32 *)(entry + offsetof(CritterSfxRecord, linkIndex)), parent, arg3, result);
    }
    return result;
}
                    ...
                    s32 parented, u32 flags)
{
    ...
    effect = *(s32 *)(sfx + offsetof(CritterSfxRecord, textureId));
    ...
    result = StartFXSub(effect, position, effectFlags, treeFlags,
                        *(f32 *)(sfx + offsetof(CritterSfxRecord, life)));
    ...
    color = *(u32 *)(sfx + offsetof(CritterSfxRecord, tintColor));
    if (color != 0xFFFFFFFF) {
...
void CritterDoParticle(Critter *c, void *sfx, s32 node)
{
    ...
    rate = (f32)(lbl_80346630 * *(f32 *)(s + offsetof(CritterSfxRecord, rate)));
    flags = *(u32 *)(s + offsetof(CritterSfxRecord, flags));
    tex = *(s32 *)(s + offsetof(CritterSfxRecord, textureId));
    etime = *(f32 *)(s + offsetof(CritterSfxRecord, life));
    speed = (f32)(lbl_80346540 * (f64)*(s16 *)(s + offsetof(CritterSfxRecord, custom1)));
    ...
    if (psys == NULL) {
        ...
        *(f32 *)((u8 *)psys + 0x30) = *(f32 *)(s + offsetof(CritterSfxRecord, color));
...
Critter *CritterNewInst(s32 type, s32 subtype, void *object)
{
    ...
    childIndex = *(s16 *)(header + offsetof(CritterPackedType, childIndex));
    root->childcnt = 0;
    tail = root;
    while (childIndex >= 0) {
        ...
        *(CritterChildLinks *)&child->colhandle =
        ...
        nodeIndex = *(s16 *)(childDef + offsetof(CritterPackedType, node0Index));
        if (nodeIndex < 0) {
            node = NULL;
        } else {
        ...
        child->hitnode0 = node;
        if ((*(u32 *)(childDef + offsetof(CritterPackedType, typeFlags)) & 0x10) != 0 &&
            child->hitnode0 != NULL &&
            *(void **)((u8 *)child->hitnode0 + 0x74) != NULL) {
            child->hitnode0 = *(void **)((u8 *)child->hitnode0 + 0x74);
        }

        nodeIndex = *(s16 *)(childDef + offsetof(CritterPackedType, node1Index));
        if (nodeIndex < 0) {
            node = NULL;
        } else {
            node = *(void **)((u8 *)child->anodes + nodeIndex * 0x28);
        ...
        nodeIndex = *(s16 *)(childDef + offsetof(CritterPackedType, node2Index));
        if (nodeIndex < 0) {
            node = NULL;
        } else {
            node = *(void **)((u8 *)child->anodes + nodeIndex * 0x28);
        ...
        tail = child;
        child->parent = root;
        childIndex = *(s16 *)(childHeader + offsetof(CritterPackedType, childIndex));
        root->childcnt++;
    }
...
void CritterInitColnodes(Critter *c)
{
    ...
    header = (u8 *)c->hdr;
    if (*(s16 *)(header + offsetof(CritterPackedType, colCount)) <= 0) {
        return;
    }
    descriptorBase = *(u8 **)(*(u8 **)(header + offsetof(CritterPackedType, file)) +
                               offsetof(CritterFileHeader, nodes)) +
                      *(s16 *)(header + offsetof(CritterPackedType, colBase)) * 0x50;
    c->unkAB8 = -1;
    zerof = lbl_80346470;
    for (i = 0; i < *(s16 *)((u8 *)c->hdr + offsetof(CritterPackedType, colCount));
         i++) {
        record = (u8 *)c + offsetof(Critter, hitnodes) + i * sizeof(CritterHitNode);
        *(u8 **)(record + offsetof(CritterHitNode, descriptor)) =
            descriptorBase + i * sizeof(CritterColDescriptor);
        nodeIndex = *(s16 *)(*(u8 **)(record + offsetof(CritterHitNode, descriptor)) +
                              offsetof(CritterColDescriptor, nodeIndex));
        if ((s16)nodeIndex >= 0) {
            *(void **)(record + offsetof(CritterHitNode, active)) =
                CritterColnodeAnimNode(c, nodeIndex);
        } else {
            *(void **)(record + offsetof(CritterHitNode, active)) = NULL;
        }
        *(void **)(record + offsetof(CritterHitNode, boundNode)) =
            *(void **)(record + offsetof(CritterHitNode, active));
        if (*(void **)(record + offsetof(CritterHitNode, active)) != NULL) {
            descriptor = *(u8 **)(record + offsetof(CritterHitNode, descriptor));
            ch = *(s8 *)(name = (char *)descriptor +
                                 offsetof(CritterColDescriptor, name));
            if (ch != 0) {
                if (ch == '-') {
                    s32 n = *(s8 *)(*(u8 **)(record + offsetof(CritterHitNode,
                                     descriptor)) +
                                     offsetof(CritterColDescriptor, name) + 1) - '0';
                    while (n > 0) {
                        *(void **)(record + offsetof(CritterHitNode, boundNode)) =
        ...
        MBTreeSetZsortAdd(
            *(void **)(record + offsetof(CritterHitNode, active)),
            *(s16 *)(*(u8 **)(record + offsetof(CritterHitNode, descriptor)) +
                      offsetof(CritterColDescriptor, zsortParam)), 1);
        *(s32 *)(record + offsetof(CritterHitNode, state)) = -1;
        *(f32 *)(record + offsetof(CritterHitNode, activeFrom)) = zerof;
        *(f32 *)(record + offsetof(CritterHitNode, activeUntil)) =
            *(f32 *)(*(u8 **)(record + offsetof(CritterHitNode, descriptor)) +
                      offsetof(CritterColDescriptor, healthScale)) * c->health;
        {
            u8 *psys;
            s32 sfxidx = *(s16 *)(*(u8 **)(record + offsetof(CritterHitNode,
                                    descriptor)) +
                                    offsetof(CritterColDescriptor, sfxIndex));
            void *hdr130 = *(void **)((u8 *)c->hdr +
                            offsetof(CritterPackedType, file));
            void *sfxparam =
                *(void **)(*(u8 **)((u8 *)c->hdr +
                            offsetof(CritterPackedType, descriptor)) +
                            offsetof(CritterDescriptor, model));
            if (sfxidx >= 0) {
                psys = *(u8 **)((u8 *)hdr130 + offsetof(CritterFileHeader, damage)) +
                       sfxidx * 0x50;
                CritterInitSfx(hdr130, *(s16 *)(psys + offsetof(CritterDamageDef, sfxIndex)), sfxparam);
                CritterInitSfx(hdr130, *(s16 *)(psys + offsetof(CritterDamageDef, morphTargetIndex)), sfxparam);
                CritterInitSfx(hdr130, *(s16 *)(psys + offsetof(CritterDamageDef, morphIndex)), sfxparam);
                CritterInitSfx(hdr130, *(s16 *)(psys + offsetof(CritterDamageDef, sfx)), sfxparam);
                if (*(s16 *)(psys + offsetof(CritterDamageDef, type)) == 6) {
                    lbl_80344650 = 1;
                }
            }
        }
        if ((gControllerButtons & 0x10) && gGameOptions[8]) {
            *(void **)(record + offsetof(CritterHitNode, dmgfx)) = DmgFxCircleAdd(
                *(void **)(record + offsetof(CritterHitNode, active)),
                *(f32 *)(*(u8 **)(record + offsetof(CritterHitNode, descriptor)) +
                          offsetof(CritterColDescriptor, radius)),
                lbl_80346470, lbl_80346470,
                (f32 *)(*(u8 **)(record + offsetof(CritterHitNode, descriptor)) +
                         offsetof(CritterColDescriptor, position)), 127);
        }
    }
}
...
void CritterLoadFinish(u8 *header)
{
    ...
    if (*(s16 *)(header + offsetof(CritterPackedType, parentIndex)) < 0) {
        ...
        *(void **)(header + offsetof(CritterPackedType, atree)) =
        ...
        parent = *(u8 **)(*(u8 **)(header + offsetof(CritterPackedType, file)) +
                 ...
                 *(s16 *)(header + offsetof(CritterPackedType, parentIndex)) *
    ...
    *(s16 *)(header + offsetof(CritterPackedType, node0Index)) = (s16)index;
    index = -1;
    atree = *(void **)(header + offsetof(CritterPackedType, atree));
    ...
    *(s16 *)(header + offsetof(CritterPackedType, node1Index)) = (s16)index;
    index = -1;
    atree = *(void **)(header + offsetof(CritterPackedType, atree));
    ...
    *(s16 *)(header + offsetof(CritterPackedType, node2Index)) = (s16)index;
}
...
void CritterInitMoves(u8 *header)
{
    ...
    atree = *(void **)(header + offsetof(CritterPackedType, atree));
    container = *(u8 **)(header + offsetof(CritterPackedType, file));
    moves = *(u8 **)(container + offsetof(CritterFileHeader, moves)) +
            *(s16 *)(header + offsetof(CritterPackedType, moveIndex)) * 0x90;
    colnodes = *(u8 **)(container + offsetof(CritterFileHeader, nodes)) +
               *(s16 *)(header + offsetof(CritterPackedType, colBase)) * 0x50;
    if (atree == NULL) {
        return;
    }
    if (*(s16 *)(header + offsetof(CritterPackedType, moveCount)) > lbl_80344630) {
        lbl_80344630 = *(s16 *)(header + offsetof(CritterPackedType, moveCount));
    }
    if (*(s16 *)(header + offsetof(CritterPackedType, auxMoveCount)) > lbl_80344634) {
        lbl_80344634 = *(s16 *)(header + offsetof(CritterPackedType, auxMoveCount));
    }
    if (*(s16 *)(header + offsetof(CritterPackedType, colCount)) > lbl_80344638) {
        lbl_80344638 = *(s16 *)(header + offsetof(CritterPackedType, colCount));
    }

    i = 0;
    while (i < *(s16 *)(header + offsetof(CritterPackedType, moveCount))) {
        entry = moves + i * 0x90;
        if (*(s32 *)entry >= 0x30 && *(s32 *)entry <= 0x39) {
            *(u32 *)(header + offsetof(CritterPackedType, typeFlags)) |= 0x10000;
        }
        if (*(s16 *)(entry + offsetof(CritterMove, anim)) >= 0) {
            goto next_move;
        }
        if (*(char *)(entry + offsetof(CritterMoveNames, anim)) != '\0') {
            index = AtreeHeaderFindSeq(atree, (char *)(entry + offsetof(CritterMoveNames, anim)));
            *(s16 *)(entry + offsetof(CritterMove, anim)) = (s16)index;
            if (*(s16 *)(entry + offsetof(CritterMove, anim)) < 0) {
                ErrorPrintf(lbl_801122F0,
                            (char *)(*(u8 **)(header + offsetof(CritterPackedType,
                                       descriptor)) + offsetof(CritterDescriptor, prefix)),
                            (char *)(entry + offsetof(CritterMoveNames, anim)));
                *(s16 *)(entry + offsetof(CritterMove, anim)) = 0;
            }
        }
        index = -1;
        {
            void *lookupAtree = *(void **)(header + offsetof(CritterPackedType, atree));
        if (lookupAtree != NULL && (entry + offsetof(CritterMoveNames, colnode)) != NULL &&
            *(char *)(entry + offsetof(CritterMoveNames, colnode)) != '\0' &&
            *(char *)(entry + offsetof(CritterMoveNames, colnode) + 1) != '\0') {
            index = AtreeFindNodeIdx(*(void **)((u8 *)lookupAtree + offsetof(struct atreeheader, nodeinfo)),
                                     *(s32 *)((u8 *)lookupAtree + offsetof(struct atreeheader, numnodes)),
                                     (char *)(entry + offsetof(CritterMoveNames, colnode)), 0x10);
        }
        }
        *(s16 *)(entry + offsetof(CritterMove, node)) = (s16)index;

        index = *(s16 *)(entry + offsetof(CritterMove, interruptAnim0));
        {
            u8 *sfx;
            void *sfxHeader;
            sfxHeader = *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                                    descriptor)) + offsetof(CritterDescriptor, model));
        if (index >= 0) {
            sfx = *(u8 **)(container + offsetof(CritterFileHeader, damage)) +
                  index * 0x50;
            CritterInitSfx(container, *(s16 *)(sfx + offsetof(CritterDamageDef, sfxIndex)), sfxHeader);
            CritterInitSfx(container, *(s16 *)(sfx + offsetof(CritterDamageDef, morphTargetIndex)), sfxHeader);
            CritterInitSfx(container, *(s16 *)(sfx + offsetof(CritterDamageDef, morphIndex)), sfxHeader);
            CritterInitSfx(container, *(s16 *)(sfx + offsetof(CritterDamageDef, sfx)), sfxHeader);
            if (*(s16 *)sfx == 6) {
                lbl_80344650 = 1;
            }
        }
        }
        {
            u8 *sfx;
            void *sfxHeader;
            index = *(s16 *)(entry + offsetof(CritterMove, interruptAnim1));
            sfxHeader = *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                                    descriptor)) + offsetof(CritterDescriptor, model));
        if (index >= 0) {
            sfx = *(u8 **)(container + offsetof(CritterFileHeader, damage)) +
        ...
        CritterInitSfx(container, *(s16 *)(entry + offsetof(CritterMoveFx, sfx)),
                       *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                                   descriptor)) + offsetof(CritterDescriptor, model)));
        CritterInitSfx(container, *(s16 *)(entry + offsetof(CritterMoveFx, sfx2)),
                       *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                                   descriptor)) + offsetof(CritterDescriptor, model)));
next_move:
        i++;
    ...
    {
    s32 colIndex = 0;
    while (colIndex < *(s16 *)(header + offsetof(CritterPackedType, colCount))) {
        u8 *colnode;
        void *lookupAtree;
        colnode = colnodes + colIndex * 0x50;
        index = -1;
        lookupAtree = *(void **)(header + offsetof(CritterPackedType, atree));
        ...
        *(s16 *)(colnode + offsetof(CritterColDescriptor, nodeIndex)) = (s16)index;
        colIndex++;
    }
    }

    CritterInitSfx(container, *(s16 *)(header + offsetof(CritterPackedType, sfxIndex0)),
                   *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                               descriptor)) + offsetof(CritterDescriptor, model)));
    CritterInitSfx(container, *(s16 *)(header + offsetof(CritterPackedType, sfxIndex1)),
                   *(void **)(*(u8 **)(header + offsetof(CritterPackedType,
                               descriptor)) + offsetof(CritterDescriptor, model)));
    *(u8 **)(header + offsetof(CritterPackedType, movesPtr)) = moves;
    *(u8 **)(header + offsetof(CritterPackedType, colnodesPtr)) = colnodes;
    *(u8 **)(header + offsetof(CritterPackedType, patternsPtr)) =
        *(u8 **)(container + offsetof(CritterFileHeader, patterns)) +
        *(s16 *)(header + offsetof(CritterPackedType, patternIndex)) * 0x50;
}
...
void CritterInitSfx(void *file, s32 index, void *atreeHeader)
{
    ...
    entry = *(u8 **)((u8 *)file + offsetof(CritterFileHeader, sfx)) +
            index * sizeof(CritterSfxRecord);
    if (*(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) < 0) {
        if ((*(u32 *)(entry + offsetof(CritterSfxRecord, flags)) &
             0x0F000100) != 0) {
            if (*(char *)(entry + offsetof(CritterSfxRecord, name)) != '\0') {
                *(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) =
                    FindTexMod(atreeHeader,
                               (char *)(entry + offsetof(CritterSfxRecord, name)),
                               NULL);
                if (*(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) <= 0) {
                ...
                *(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) = -1;
            }
        } else {
            *(s32 *)(entry + offsetof(CritterSfxRecord, textureId)) =
                InitCustomEffect(
                    atreeHeader,
                    (char *)(entry + offsetof(CritterSfxRecord, name)),
                    *(s16 *)(entry + offsetof(CritterSfxRecord, custom0)),
                    *(s16 *)(entry + offsetof(CritterSfxRecord, custom1)));
        }
    }
    if (*(s32 *)(entry + offsetof(CritterSfxRecord, audioId)) < 0) {
        if (*(char *)(entry + offsetof(CritterSfxRecord, levelFmt)) != '\0') {
            ...
            *(s32 *)(entry + offsetof(CritterSfxRecord, audioId)) = -1;
        }
    }
    CritterInitSfx(file, *(s32 *)(entry + offsetof(CritterSfxRecord, linkIndex)),
                   atreeHeader);
}
