...
#ifdef __MWERKS__
asm void camera_mode_dest(s32 camIdx)
{
    nofralloc
    mflr r0
    mulli r5,r3,396
    ...
    cmpwi r3,0
    stfd f31,200(r1)
    addi r0,r4,gCameras@l
    stmw r29,188(r1)
    add r31,r0,r5
    bne camera_mode_dest_L0A90
    lfs f0,lbl_80345EC8(r0)
    stfs f0,132(r31)
    stfs f0,136(r31)
    stfs f0,140(r31)
    stfs f0,148(r31)
    ...
    lwz r0,208(r31)
    cmpwi r0,2
    blt camera_mode_dest_L0A90
    lwz r0,lbl_8034441C(r0)
    cmpwi r0,0
    beq camera_mode_dest_L0074
    bge camera_mode_dest_L0068
    b camera_mode_dest_L02A4
camera_mode_dest_L0068:
    cmpwi r0,2
    bge camera_mode_dest_L02A4
    b camera_mode_dest_L0144
camera_mode_dest_L0074:
    lwz r4,gFrameTicks(r0)
    lis r3,17200
    lfs f3,196(r31)
    li r0,1
    stw r4,172(r1)
    ...
    stw r3,168(r1)
    fsubs f0,f3,f0
    lfd f1,lbl_803460A0(r0)
    stw r4,180(r1)
    lfd f4,lbl_80345F50(r0)
    lfd f2,168(r1)
    stw r3,176(r1)
    fmul f0,f1,f0
    lfd f5,lbl_80346098(r0)
    fsub f1,f2,f4
    lfd f2,176(r1)
    fsub f2,f2,f4
    fmul f0,f1,f0
    ...
    fneg f2,f4
    stfs f0,196(r31)
    stw r0,lbl_803443F4(r0)
    stfs f2,132(r31)
    lfs f1,104(r31)
    lfs f0,228(r31)
    fcmpo cr0,f1,f0
    bge camera_mode_dest_L0104
    lfd f0,lbl_80345F88(r0)
    fmul f0,f0,f4
    frsp f0,f0
    stfs f0,136(r31)
    b camera_mode_dest_L0120
camera_mode_dest_L0104:
    lfs f0,232(r31)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L0120
    lfd f0,lbl_80345F88(r0)
    fmul f0,f0,f2
    frsp f0,f0
    stfs f0,136(r31)
camera_mode_dest_L0120:
    lwz r3,gFrameTicks(r0)
    lwz r0,lbl_80344420(r0)
    subf. r0,r3,r0
    stw r0,lbl_80344420(r0)
    bgt camera_mode_dest_L0A90
    lwz r0,lbl_8034429C(r0)
    add r0,r0,r3
    stw r0,lbl_8034429C(r0)
    b camera_mode_dest_L0A90
camera_mode_dest_L0144:
    lwz r3,gFrameTicks(r0)
    lis r0,17200
    lfd f1,lbl_80345F50(r0)
    stw r3,172(r1)
    lfd f2,lbl_803460A8(r0)
    stw r0,168(r1)
    lfs f3,168(r31)
    lfd f0,168(r1)
    fsub f0,f0,f1
    ...
    stfs f0,168(r31)
    lfs f1,168(r31)
    lfd f0,lbl_80345F58(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L0194
    lfd f0,lbl_80345F60(r0)
    fsub f1,f1,f0
    b camera_mode_dest_L01AC
camera_mode_dest_L0194:
    lfd f0,lbl_80345F68(r0)
    fcmpo cr0,f1,f0
    cror eq,lt,eq
    bne camera_mode_dest_L01AC
    lfd f0,lbl_80345F60(r0)
    fadd f1,f0,f1
camera_mode_dest_L01AC:
    frsp f0,f1
    addi r3,r1,104
    addi r4,r31,164
    stfs f0,168(r31)
...
camera_mode_dest_L02A4:
    ...
    stw r4,172(r1)
    fneg f0,f0
    lfd f2,lbl_80345F50(r0)
    stw r0,168(r1)
    lfd f3,lbl_80346098(r0)
    lfd f1,168(r1)
    stfs f0,164(r31)
    fsub f0,f1,f2
    fmul f31,f3,f0
    ...
    fneg f0,f0
    stfs f0,164(r31)
    lwz r0,lbl_80344510(r0)
    lwz r3,lbl_8034450C(r0)
    cmpw r0,r3
    beq camera_mode_dest_L03CC
    mulli r0,r3,40
    lis r3,sTriggerCameras@ha
    addi r29,r3,sTriggerCameras@l
    add r4,r29,r0
    addi r3,r31,100
    addi r4,r4,4
    bl get_pitch
    lwz r0,lbl_8034450C(r0)
    addi r3,r31,100
    stfs f1,lbl_80344444(r0)
    mulli r0,r0,40
    add r4,r29,r0
    addi r4,r4,4
    bl get_yaw
    stfs f1,lbl_80344448(r0)
    lfd f1,lbl_80345F60(r0)
    lfs f0,lbl_80344448(r0)
    fsub f1,f1,f0
    frsp f1,f1
    bl FixAngle
    lfd f0,lbl_803460B8(r0)
    lfd f2,lbl_803460B0(r0)
    fmul f1,f0,f1
    lfs f0,lbl_80345EC8(r0)
    fmul f1,f2,f1
    frsp f1,f1
    fcmpo cr0,f1,f0
    bge camera_mode_dest_L0378
    lfd f0,lbl_803460C0(r0)
    fadd f1,f1,f0
    frsp f1,f1
camera_mode_dest_L0378:
    lfd f0,lbl_803460C8(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L0388
    lfs f1,lbl_80345EC8(r0)
camera_mode_dest_L0388:
    lwz r0,lbl_80344A28(r0)
    cmpwi r0,0
    bne camera_mode_dest_L03CC
    lfd f2,lbl_803460B8(r0)
    lis r3,lbl_80111B3C@ha
    lfs f0,lbl_80344444(r0)
    addi r5,r3,lbl_80111B3C@l
    lfd f3,lbl_803460B0(r0)
    fmul f0,f2,f0
    crset 4*cr1+eq
    li r3,2
    li r4,3
    ...
    lwz r6,172(r1)
    bl dbgTextPrintfCol
camera_mode_dest_L03CC:
    lwz r0,lbl_80344510(r0)
    lwz r4,lbl_8034450C(r0)
    cmpw r0,r4
    beq camera_mode_dest_L04EC
    lis r3,sTriggerCameras@ha
    lfs f0,100(r31)
    addi r3,r3,sTriggerCameras@l
    mulli r0,r0,40
    addi r5,r3,4
    lfsx f1,r5,r0
    addi r6,r3,8
    ...
    fadds f0,f1,f0
    stfs f0,88(r1)
    b camera_mode_dest_L050C
camera_mode_dest_L04EC:
    lfs f0,lbl_80345EC8(r0)
    lwz r3,lbl_8034429C(r0)
    stfs f0,80(r1)
    lwz r0,gFrameTicks(r0)
    stfs f0,84(r1)
    add r0,r3,r0
    stfs f0,88(r1)
    stw r0,lbl_8034429C(r0)
camera_mode_dest_L050C:
    lfs f1,80(r1)
    lfs f0,84(r1)
    fmuls f2,f1,f1
    lfs f3,88(r1)
    ...
    fadds f4,f3,f1
    fcmpo cr0,f4,f0
    ble camera_mode_dest_L0594
    frsqrte f1,f4
    lfd f3,lbl_80345F18(r0)
    lfd f2,lbl_80345F20(r0)
    fmul f0,f1,f1
    fmul f1,f3,f1
    fnmsub f0,f4,f0,f2
    fmul f1,f1,f0
    ...
    stfs f0,24(r1)
    lfs f4,24(r1)
camera_mode_dest_L0594:
    lfd f0,lbl_803460D0(r0)
    fcmpo cr0,f4,f0
    cror eq,gt,eq
    beq camera_mode_dest_L05B4
    lwz r3,lbl_80344510(r0)
    lwz r0,lbl_8034450C(r0)
    cmpw r3,r0
    beq camera_mode_dest_L0938
camera_mode_dest_L05B4:
    lfs f0,lbl_8034442C(r0)
    lfs f4,lbl_80344444(r0)
    fcmpo cr0,f0,f4
    bge camera_mode_dest_L0628
    lfs f1,lbl_80344424(r0)
    lfd f0,lbl_80345F70(r0)
    fcmpo cr0,f1,f0
    bge camera_mode_dest_L05E4
    lfd f0,lbl_803460D8(r0)
    fadd f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344424(r0)
camera_mode_dest_L05E4:
    lwz r3,gFrameTicks(r0)
    lis r0,17200
    lfd f2,lbl_80345F50(r0)
    stw r3,172(r1)
    lfs f3,lbl_80344424(r0)
    stw r0,168(r1)
    lfs f0,lbl_8034442C(r0)
    lfd f1,168(r1)
    fsubs f1,f1,f2
    fmadds f0,f3,f1,f0
    stfs f0,lbl_8034442C(r0)
    lfs f0,lbl_8034442C(r0)
    fcmpo cr0,f0,f4
    cror eq,gt,eq
    bne camera_mode_dest_L0694
    li r30,1
    b camera_mode_dest_L0694
camera_mode_dest_L0628:
    ble camera_mode_dest_L0690
    lfs f1,lbl_80344424(r0)
    lfd f0,lbl_803460E0(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L064C
    lfd f0,lbl_803460D8(r0)
    fsub f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344424(r0)
camera_mode_dest_L064C:
    lwz r3,gFrameTicks(r0)
    lis r0,17200
    lfd f2,lbl_80345F50(r0)
    stw r3,172(r1)
    ...
    li r30,1
    b camera_mode_dest_L0694
camera_mode_dest_L0690:
    li r30,1
camera_mode_dest_L0694:
    cmpwi r30,0
    beq camera_mode_dest_L06D4
    lfs f1,lbl_80344424(r0)
    lfd f0,lbl_80345F78(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L06C0
    lfd f0,lbl_803460D8(r0)
    fsub f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344424(r0)
    b camera_mode_dest_L06D4
camera_mode_dest_L06C0:
    bge camera_mode_dest_L06D4
    lfd f0,lbl_803460D8(r0)
    fadd f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344424(r0)
camera_mode_dest_L06D4:
    lfs f2,lbl_80344448(r0)
    li r4,0
    lfs f1,lbl_80344430(r0)
    lfd f0,lbl_80345F58(r0)
    fsubs f1,f2,f1
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L06FC
    lfd f0,lbl_80345F60(r0)
    fsub f0,f1,f0
    b camera_mode_dest_L071C
camera_mode_dest_L06FC:
    lfd f0,lbl_80345F68(r0)
    fcmpo cr0,f1,f0
    cror eq,lt,eq
    bne camera_mode_dest_L0718
    lfd f0,lbl_80345F60(r0)
    fadd f0,f0,f1
    b camera_mode_dest_L071C
camera_mode_dest_L0718:
    fmr f0,f1
camera_mode_dest_L071C:
    lwz r3,gFrameTicks(r0)
    lis r0,17200
    frsp f4,f0
    lfs f0,lbl_80345EC8(r0)
    ...
    stw r0,168(r1)
    fcmpo cr0,f4,f0
    lfs f3,lbl_80344428(r0)
    lfd f1,168(r1)
    fsubs f1,f1,f2
    fmuls f2,f3,f1
    ble camera_mode_dest_L0790
    lfd f0,lbl_80345F70(r0)
    fcmpo cr0,f3,f0
    bge camera_mode_dest_L076C
    lfd f0,lbl_803460D8(r0)
    fadd f0,f3,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
camera_mode_dest_L076C:
    lfs f0,lbl_80345EC8(r0)
    fcmpo cr0,f2,f0
    cror eq,gt,eq
    bne camera_mode_dest_L0804
    fcmpo cr0,f4,f2
    cror eq,lt,eq
    bne camera_mode_dest_L0804
    li r4,1
    b camera_mode_dest_L0804
camera_mode_dest_L0790:
    bge camera_mode_dest_L07D4
    lfd f0,lbl_803460E0(r0)
    fcmpo cr0,f3,f0
    ble camera_mode_dest_L07B0
    lfd f0,lbl_803460D8(r0)
    fsub f0,f3,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
camera_mode_dest_L07B0:
    lfs f0,lbl_80345EC8(r0)
    fcmpo cr0,f2,f0
    cror eq,lt,eq
    bne camera_mode_dest_L0804
    ...
    li r4,1
    b camera_mode_dest_L0804
camera_mode_dest_L07D4:
    fcmpo cr0,f3,f0
    ble camera_mode_dest_L07F0
    lfd f0,lbl_803460D8(r0)
    fsub f0,f3,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
    b camera_mode_dest_L0804
camera_mode_dest_L07F0:
    bge camera_mode_dest_L0804
    lfd f0,lbl_803460D8(r0)
    fadd f0,f3,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
camera_mode_dest_L0804:
    cmpwi r4,0
    beq camera_mode_dest_L0844
    lfs f1,lbl_80344428(r0)
    lfs f0,lbl_80345EC8(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L0830
    lfd f0,lbl_803460D8(r0)
    fsub f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
    b camera_mode_dest_L0844
camera_mode_dest_L0830:
    bge camera_mode_dest_L0844
    lfd f0,lbl_803460D8(r0)
    fadd f0,f1,f0
    frsp f0,f0
    stfs f0,lbl_80344428(r0)
camera_mode_dest_L0844:
    lfs f1,lbl_80344430(r0)
    lfd f0,lbl_80345F58(r0)
    fadds f1,f1,f2
    stfs f1,lbl_80344430(r0)
    lfs f1,lbl_80344430(r0)
    fcmpo cr0,f1,f0
    ble camera_mode_dest_L086C
    lfd f0,lbl_80345F60(r0)
    fsub f1,f1,f0
    b camera_mode_dest_L0884
camera_mode_dest_L086C:
    lfd f0,lbl_80345F68(r0)
    fcmpo cr0,f1,f0
    cror eq,lt,eq
    bne camera_mode_dest_L0884
    lfd f0,lbl_80345F60(r0)
    fadd f1,f0,f1
camera_mode_dest_L0884:
    frsp f2,f1
    lfs f0,lbl_8034442C(r0)
    lfd f1,lbl_80345F58(r0)
    stfs f0,48(r1)
    stfs f2,lbl_80344430(r0)
    lfs f0,lbl_80344430(r0)
    fadd f2,f1,f0
    fcmpo cr0,f2,f1
    ble camera_mode_dest_L08B4
    lfd f0,lbl_80345F60(r0)
    fsub f2,f2,f0
    b camera_mode_dest_L08CC
camera_mode_dest_L08B4:
    lfd f0,lbl_80345F68(r0)
    fcmpo cr0,f2,f0
    cror eq,lt,eq
    bne camera_mode_dest_L08CC
    lfd f0,lbl_80345F60(r0)
    fadd f2,f0,f2
camera_mode_dest_L08CC:
    frsp f1,f2
    lfs f0,lbl_80345EC8(r0)
    addi r3,r1,104
    addi r4,r1,48
    ...
    fadds f0,f1,f0
    stfs f0,108(r31)
camera_mode_dest_L0938:
    lfs f5,lbl_80345EC8(r0)
    lis r0,17200
    stfs f5,180(r31)
    stfs f5,184(r31)
    stfs f5,188(r31)
    lwz r3,gFrameTicks(r0)
    lfs f6,lbl_80344530(r0)
    stw r3,172(r1)
    lfs f1,lbl_80344408(r0)
    stw r0,168(r1)
    fsubs f0,f6,f1
    lfd f3,lbl_80345F50(r0)
    lfd f2,168(r1)
    lfs f4,lbl_80344450(r0)
    fsubs f2,f2,f3
    fcmpo cr0,f0,f5
    fmuls f0,f4,f2
    ble camera_mode_dest_L09A0
    fadds f0,f1,f0
    stfs f0,lbl_80344408(r0)
    lfs f0,lbl_80344408(r0)
    fcmpo cr0,f6,f0
    cror eq,lt,eq
    bne camera_mode_dest_L09BC
    stfs f6,lbl_80344408(r0)
    b camera_mode_dest_L09BC
camera_mode_dest_L09A0:
    fsubs f0,f1,f0
    stfs f0,lbl_80344408(r0)
    lfs f0,lbl_80344408(r0)
    fcmpo cr0,f6,f0
