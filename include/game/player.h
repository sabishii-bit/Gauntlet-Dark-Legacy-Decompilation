 ...
 */
/* -- player_action_type (Xbox shell3D.pdb, misc.h; the declared type of
 *    the Xbox player record's action/daction fields).  Adopted on GC
 *    evidence, not position: PlayerAttackType (action.c) classifies
 *    seq 4..7 and 8 as one group -- exactly P_DEFENDL..P_DEFENDF and
 *    P_SHOVE -- and splits the attack band at 32/39/44/60/62/71/79/86,
 *    which are the enum's own group edges; DoPlayerAction's dispatcher
 *    runs from 0 to 0x95 == P_NACTIONS. -- */
typedef enum player_action_type {
    P_READY = 0,
    P_IDLE1 = 1,
    P_IDLE2 = 2,
    P_IDLE2_LOOP = 3,
    ...
    P_ATTACK_SLOW1 = 33,
    P_ATTACK_SLOW1_R = 34,
    P_ATTACK_PWRA_CLOSE = 35,
    P_ATTACK_PWRA_CLOSE_R = 36,
    P_ATTACK_PWRA_MED = 37,
    P_ATTACK_PWRA_MED_R = 38,
    P_ATTACK_QUICK = 39,
    P_ATTACK_QUICK2 = 40,
    P_ATTACK_QUICK3 = 41,
    P_ATTACK_QUICK2_R = 42,
    P_ATTACK_QUICK3_R = 43,
    P_ATTACK_RIGHT = 44,
    P_ATTACK_RIGHT2 = 45,
    P_ATTACK_RIGHT_R = 46,
    P_ATTACK_RIGHT2_R = 47,
    P_ATTACK_LEFT = 48,
    P_ATTACK_LEFT2 = 49,
    P_ATTACK_LEFT_R = 50,
    P_ATTACK_LEFT2_R = 51,
    ...
    P_ATTACK_STEP2_R = 65,
    P_ATTACK_STEP3_R = 66,
    P_ATTACK_Q3TOSTEP1 = 67,
    P_ATTACK_Q3TOSTEP1_R = 68,
    P_ATTACK_WALK2 = 69,
    P_ATTACK_WALK2_R = 70,
    P_STRAFE_ATKF = 71,
    P_STRAFE_ATKF2 = 72,
    ...
    P_ATTACK_KICK = 82,
    P_ATTACK_KICK_R = 83,
    P_ATTACK_PWRA_LOW = 84,
    P_ATTACK_PWRA_LOW_R = 85,
    P_ATTACK_PWRB = 86,
    P_ATTACK_PWRC = 87,
    P_COMBO_ACTIVE1 = 88,
    P_COMBO_ACTIVE2 = 89,
    ...
    P_THROW_RECOVER = 97,
    P_THROW2_RECOVER = 98,
    P_ATTACK_PWRA_THROW = 99,
    P_ATTACK_PWRA_THROW_R = 100,
    P_THROW_STEP = 101,
    P_THROW_STEP2 = 102,
    P_FIREL = 103,
    P_FIRER = 104,
